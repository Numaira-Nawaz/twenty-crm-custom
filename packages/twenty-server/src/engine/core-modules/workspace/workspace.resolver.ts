...
export class WorkspaceResolver {
  ...
  async createWorkspace(
    ...
    const newWorkspace = await this.workspaceService.createOne({
      displayName: 'Brackets',
      logo: 'https://twentyhq.github.io/placeholder-images/workspaces/brackets-logo.png', // Example logo URL
      inviteHash: 'brackets.dev-invite-hash',
      subdomain: 'brackets',
